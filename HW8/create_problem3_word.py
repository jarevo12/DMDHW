#!/usr/bin/env python3
"""Convert Problem 3 Solution markdown to Word document."""
...
if __name__ == "__main__":
    markdown_file = "/workspaces/DMDHW/Problem3_Solution.md"
    output_file = "/workspaces/DMDHW/Problem3_Solution.docx"
