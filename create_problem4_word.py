#!/usr/bin/env python3
"""Convert Problem 4 Solution markdown to Word document."""
...
if __name__ == "__main__":
    markdown_file = "/workspaces/DMDHW/Problem4_Solution.md"
    output_file = "/workspaces/DMDHW/Problem4_Solution.docx"
